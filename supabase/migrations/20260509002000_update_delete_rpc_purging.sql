-- ============================================================
-- Migration: Update delete_crm_lead_robust to include client_consents (V4.2)
-- Purpose: Ensures all historical data including consent forms are cleared
--          when a lead is deleted permanently.
-- Date: 2026-05-09
-- ============================================================
