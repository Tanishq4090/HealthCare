                                                ...
                                                {showEndConfirm === service.id ? (
                                                    <div className="flex items-center gap-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                                        ...
                                                        <p className="text-xs text-red-700">
                                                            This will release all {activeWorkers.length} worker(s), generate final payslips, and settle the deposit. Continue?
                                                        </p>
                                                        <button
                                                            onClick={() => handleEndService(service.id)}
                                                            disabled={endingServiceId === service.id}
                                                            className="px-3 py-1 text-xs font-bold bg-red-600 text-white rounded-md hover:bg-red-700 disabled:opacity-50 whitespace-nowrap"
                                                        >
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium bg-red-50 text-red-700 border border-red-200 rounded-lg hover:bg-red-100 transition-colors"
                                                    >
