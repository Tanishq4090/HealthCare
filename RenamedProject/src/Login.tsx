        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 selection:bg-primary/20">
            ...
            <div className="w-full max-w-sm login-card">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-extrabold text-slate-900 mb-2 tracking-tight">Healthcare OS</h1>
                ...
                <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-xl shadow-slate-200/50">
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full liquid-glass-btn-blue font-bold py-3.5 px-4 text-white flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed mt-2 text-lg"
                        >
                            {isLoading ? (
                ...
                <div className="text-center mt-8 text-xs text-slate-400">
                    <p>Secured by Healthcare OS Authentication</p>
                </div>
            </div>
        </div>
    );
