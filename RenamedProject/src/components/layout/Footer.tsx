...
export default function Footer() {
  return (
    <footer className="bg-[#0F172A] dark:bg-slate-950 text-white pt-20 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/healthcareservy/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-brand-blue hover:text-white hover:border-brand-blue transition-all">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              {/* WhatsApp */}
              <a href="https://api.whatsapp.com/send/?phone=917971542924&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-brand-green hover:text-white hover:border-brand-green transition-all">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              {/* X / Twitter */}
              <a href="https://x.com/HEALTHCARESERVY" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-brand-blue hover:text-white hover:border-brand-blue transition-all">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
