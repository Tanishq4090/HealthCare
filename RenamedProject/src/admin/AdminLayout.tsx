...
export default function AdminLayout() {
    ...
    return (
        <div className="min-h-screen scenic-bg flex items-center justify-center p-0 lg:p-6">
          <div className="w-full h-[100dvh] lg:h-[90dvh] max-h-[1100px] max-w-[1600px] glass-container lg:rounded-[2rem] flex overflow-hidden shadow-2xl">
            {/* Sidebar */}
            <aside className="w-64 bg-black/20 border-r border-white/10 flex flex-col hidden lg:flex">
                {/* Logo */}
                <div className="h-20 flex items-center px-6 border-b border-white/10">
                    <Link to="/admin" className="flex items-center gap-3" title="Dashboard">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-xl text-white font-['Plus_Jakarta_Sans'] leading-tight">Healthcare</span>
                            <span className="text-[10px] text-slate-300 font-bold tracking-widest uppercase leading-tight">OS</span>
                        </div>
                    </Link>
                </div>
                ...
                {user?.role === 'admin' && (
                    <div className="px-4 pb-2">
                        ...
                        >
                            <Settings className={`w-5 h-5 ${location.pathname === '/admin/settings' ? 'text-white' : 'text-slate-400'}`} />
                            Access Control
                        </Link>
                    </div>
                )}
                ...
                <div className="p-4 border-t border-white/10">
                    <div className="flex items-center gap-3 px-3 py-2 mb-2">
                        <div className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/5">
                            <span className="font-semibold text-white text-sm">{user?.avatar || 'U'}</span>
                        </div>
                    ...
                    <button onClick={handleLogout} className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-slate-400 hover:bg-red-500/20 hover:text-red-400 transition-colors font-medium">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
                {/* Top Header */}
                <header className="h-16 bg-black/10 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-10">
                    {/* Mobile menu button */}
                    <div className="lg:hidden flex items-center gap-3">
                        ...
                        <span className="font-bold text-white font-['Plus_Jakarta_Sans']">Healthcare OS</span>
                    </div>
                            ...
                            <div className="fixed inset-y-0 left-0 w-[280px] bg-white shadow-2xl flex flex-col animate-in slide-in-from-left duration-300">
                                <div className="h-20 flex items-center justify-between px-6 border-b border-slate-100">
                                    <div className="flex items-center gap-3">
                                        ...
                                        />
                                        <span className="font-bold text-xl text-[#1aa6a8] font-['Plus_Jakarta_Sans']">Healthcare</span>
                                    </div>
