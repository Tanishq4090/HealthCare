            ...
            for (const [workerId, datesSet] of Object.entries(attendanceByWorker)) {
                ...
                if (worker) {
                    ...
                    newPayrollEntries.push({
                        worker: worker.name,
                        client_name: worker.assigned_client || 'Healthcare Internal',
                    ...
                    clientDoc.text("Healthcare AI", 14, 20);
                            ...
                            <div className="flex justify-between items-start">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <img src="/healthcare-logo.svg" className="h-10 w-auto" alt="healthcare Logo" onError={(e) => {
