...
export default function Billing() {
    ...
    const generateWhatsappDraft = (bill: any, lang: string) => {
        if (!bill) return '';
        const link = `https://healthcare.com/pay/${bill.invoice_no || Math.floor(Math.random() * 1000) + 100}`;
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col border border-slate-200 max-h-[90vh] animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-8 overflow-y-auto bg-white custom-scrollbar">
                            ...
                            <div className="flex justify-between items-start mb-10">
                                <div>
                                    <div className="flex flex-col mb-4">
                                        <img src="/healthcare-logo.svg" alt="99 CARE" className="h-14 w-auto object-contain" />
                                    </div>
                                    <div className="mt-8">
                                ...
                                <div className="text-right text-xs text-slate-600 flex flex-col items-end gap-1">
                                    ...
                                    <p><span className="font-semibold text-slate-800">Email</span> info@healthcare.com</p>
                                    <p><span className="font-semibold text-slate-800">Website</span> HEALTHCARE.ORG</p>
                                </div>
                            </div>
                                ...
                                <div className="flex gap-8">
                                    <div>
                                        ...
                                        <div className="w-20 h-20 bg-slate-200 border border-slate-300 flex items-center justify-center rounded-md overflow-hidden p-1">
                                            <img src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=upi://pay?pa=healthcareforyou@okaxis&pn=99%20CARE&am=${invoiceData.amount}&cu=INR`} alt="UPI QR" className="w-full h-full object-cover" />
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="text-[11px] text-slate-600 leading-tight border-t border-slate-200 pt-3 pb-8">
                                ...
                                <p>We 99 care is part of 99FAS companies based on Services provider entities. Where we can supply all Building and maintenance related work. In our HEALTHCARE we provide best care taker and nursing services at home.</p>
