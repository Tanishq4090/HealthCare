  ...
  return (
    <PageTransition>
      <SEOMeta
        ...
        canonical="https://healthcare.com/privacy"
      />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-8">
                Your privacy is important to us. It is the policy of HEALTHCARE Helping Hand to respect your privacy regarding any information we may collect from you across our website, <a href="https://www.healthcare.com" className="text-brand-blue hover:underline">https://www.healthcare.com</a>, and other sites we own and operate.
              </p>
