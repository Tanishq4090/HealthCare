  ...
  return (
    <PageTransition>
      <SEOMeta
        ...
        canonical="https://healthcare.com/about"
      />
      ...
      <section className="py-24 bg-white dark:bg-slate-950 border-t border-gray-100 dark:border-slate-800">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          ...
          <div className="text-left space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed text-lg font-light">
            ...
            <p>
              With pride, Healthcare serves as a reliable healthcare partner for multiple families today. Continuing into the future, we still hold tight to our core values, innovating and raising the bar for home health services.
            </p>
          </div>
        </div>
      </section>
