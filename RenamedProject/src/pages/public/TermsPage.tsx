...
export default function TermsPage() {
  const sections = [
    ...
    },
    {
      ...
      content: [
        "By using the website, users consent to HEALTHCARE’s Privacy Policy.",
        "Personal data is collected, stored, and processed in compliance with Indian IT laws.",
        "Users indemnify HEALTHCARE against breaches of data protection obligations."
      ]
    },
    {
      id: "ip",
      ...
      content: [
        "All content, software, and materials on the website belong to HEALTHCARE Helping Hand.",
    ...
    },
    {
      ...
      content: [
        ...
        "HEALTHCARE does not guarantee product quality or suitability.",
  ...
  return (
    <PageTransition>
      <SEOMeta
        ...
        canonical="https://healthcare.com/terms"
      />
          ...
          <div className="container mx-auto px-6 max-w-4xl">
            <div className="bg-brand-gray/30 dark:bg-slate-900/50 p-8 rounded-3xl mb-12 border border-gray-100 dark:border-slate-800">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed italic">
                HEALTHCARE Helping Hand provides a wide range of home healthcare services, but patients must give consent, respect staff, ensure security, and comply with laws. Refunds and services follow strict policies, and HEALTHCARE limits its liability for product/service outcomes.
              </p>
            </div>
