  ...
  return (
    <PageTransition>
      <SEOMeta
        ...
        canonical="https://healthcare.com"
      />
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center text-center px-6 pt-20 pb-32 bg-white dark:bg-slate-950 overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-20 right-20 w-96 h-96 glass-btn-cyan/5 rounded-full blur-3xl -z-10" 
        />
        <motion.div 
          style={{ y: blob2Y }}
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="max-w-4xl mx-auto flex flex-col items-center">
          <motion.span 
            ...
            className="text-brand-blue dark:text-brand-blue text-xs font-bold uppercase tracking-[0.2em] mb-8 glass-btn-cyan-light/50 dark:glass-btn-cyan/20 px-4 py-1.5 rounded-full border border-brand-blue/20 dark:border-brand-blue/40"
          >
      ...
      <section className="py-24 md:py-32 glass-btn-cyan-light dark:bg-slate-900/30">
        <div className="container mx-auto px-6 max-w-7xl">
            ...
            <motion.div variants={staggerItem} className="flex gap-6 group">
              <div className="flex-shrink-0 mt-1">
                <motion.div 
                  ...
                  className="w-10 h-10 rounded-full glass-btn-cyan-light flex items-center justify-center text-brand-blue"
                >
      ...
      <section className="py-24 glass-btn-cyan text-center px-6 overflow-hidden">
