...
export default function ContactPage() {
  ...
  async function onSubmit(data: ContactFormValues) {
    try {
      ...
      setErrorMsg("Something went wrong. Please call us at +91 9016 116 564.");
  ...
  return (
    <PageTransition>
      <SEOMeta
        ...
        canonical="https://healthcare.com/contact"
      />
                ...
                <div className="bg-white dark:bg-slate-900 p-8 md:p-10 rounded-[2rem] border border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow duration-300 sticky top-32 space-y-8">
                  <div>
                    ...
                    <div className="flex flex-col gap-6 text-gray-600 dark:text-gray-400">
                      ...
                      <a href="mailto:info@healthcare.com" className="flex items-center gap-4 hover:text-brand-blue transition-colors group">
                    ...
                    <div className="flex gap-4 mb-8">
                      ...
                      <motion.a
                        whileHover={{ y: -3, scale: 1.1 }}
                        transition={{ duration: 0.2 }}
                        href="https://www.instagram.com/healthcareservy/"
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      <motion.a
                        whileHover={{ y: -3, scale: 1.1 }}
                        transition={{ duration: 0.2 }}
                        href="https://x.com/HEALTHCARESERVY"
                        target="_blank"
                        rel="noopener noreferrer"
